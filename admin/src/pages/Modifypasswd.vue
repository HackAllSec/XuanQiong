<template>
    <div>
        <el-card style="padding: 30px;" :header="t('app.webui.alterpwd')">
            <div style="margin-top: 20px; font-size: 14px;">{{ t('app.webui.oldpassword') }}</div>
            <el-input v-model="oldpassword" size="large" :placeholder="oldpassword" style="margin-top: 10px;" type="password" show-password />
            <div style="margin-top: 20px; font-size: 14px;">{{ t('app.webui.newpassword') }}</div>
            ...
            <div style="margin-top: 20px; font-size: 14px;">{{ t('app.webui.confirmpassword') }}</div>
