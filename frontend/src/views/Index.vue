<template>
  <div style="height: 90vh;">
    <el-row justify="space-evenly">
      <el-card shadow="always" style="width: 15%; height: 30%;">
        <template #header>
          <el-row justify="space-between" style="font-weight: bold; font-size: 18px;">
      ...
      <el-card shadow="always" style="width: 15%; height: 30%;">
        <template #header>
          <el-row justify="space-between" style="font-weight: bold; font-size: 18px;">
            <span>{{ t('app.webui.totalproduct') }}</span>
            <el-icon size="25">
              <svg t="1727429889519" class="icon" viewBox="0 0 1025 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="17925" width="200" height="200"><path d="M302.32811 504.78l-146.944-88.063c-11.776-7.168-27.136-3.328-34.048 8.448-7.168 11.776-3.328 27.136 8.448 34.304l146.944 88.064c11.776 7.168 27.136 3.328 34.048-8.704 7.168-11.802 3.328-27.162-8.448-34.048zM459.00011 1020.878c5.888 1.792 12.544 1.28 18.688-2.304-5.632 3.072-12.288 4.096-18.688 2.304zM302.32811 504.78l-146.944-88.064c-11.776-7.168-27.136-3.328-34.048 8.448-7.168 11.776-3.328 27.136 8.448 34.304l146.944 88.064c11.776 7.168 27.136 3.328 34.048-8.704 7.168-11.802 3.328-27.162-8.448-34.048z m0 0l-146.944-88.064c-11.776-7.168-27.136-3.328-34.048 8.448-7.168 11.776-3.328 27.136 8.448 34.304l146.944 88.064c11.776 7.168 27.136 3.328 34.048-8.704 7.168-11.802 3.328-27.162-8.448-34.048z m0 0l-146.944-88.064c-11.776-7.168-27.136-3.328-34.048 8.448-7.168 11.776-3.328 27.136 8.448 34.304l146.944 88.064c11.776 7.168 27.136 3.328 34.048-8.704 7.168-11.802 3.328-27.162-8.448-34.048z m0 0l-146.944-88.064c-11.776-7.168-27.136-3.328-34.048 8.448-7.168 11.776-3.328 27.136 8.448 34.304l146.944 88.064c11.776 7.168 27.136 3.328 34.048-8.704 7.168-11.802 3.328-27.162-8.448-34.048z m0 0l-146.944-88.064c-11.776-7.168-27.136-3.328-34.048 8.448-7.168 11.776-3.328 27.136 8.448 34.304l146.944 88.064c11.776 7.168 27.136 3.328 34.048-8.704 7.168-11.802 3.328-27.162-8.448-34.048z" fill="#3CBF71" p-id="17926"></path><path d="M477.68811 1018.547c-6.144 3.584-12.8 4.096-18.688 2.304 6.4 1.818 13.056 0.794 18.688-2.304z" fill="#3CBF71" p-id="17927"></path><path d="M490.64111 954.112V511.744L880.27311 290.56l39.885-24.166c7.987-5.197 9.498-11.802 10.547-16.538 1.024-9.728-3.584-19.968-13.568-25.088L476.81711 4.608c-7.168-3.584-15.36-3.584-22.528 0L13.97011 224.768C-2.41489 235.52 0.14511 259.328 0.14511 261.888v469.76c0 8.704 4.608 16.896 12.032 21.504 0 0 430.848 260.352 438.272 263.68 15.104 7.424 24.576 5.376 31.744 1.792l143.36-82.944a25.56 25.56 0 0 0 9.216-35.072c-6.912-12.288-22.784-16.384-34.816-9.472l-99.072 57.6v-0.256l-10.24 5.632m-50.176-442.368v441.088l-390.4-235.264v-427.52l390.4 221.696z m25.088-43.52L78.22511 248.576 465.55311 55.04l387.328 193.536-387.328 219.648z" fill="#3CBF71" p-id="17928"></path><path d="M812.94511 917.376l201.984-121.344c5.632-3.584 9.216-9.728 9.216-16.64V556.928c0-7.834-5.888-13.312-12.288-16.384l-5.12-2.56c-0.512-0.256-1.28-0.256-1.792-0.256h1.536L810.13011 439.68c-5.376-2.56-11.776-2.56-17.152 0l-196.096 98.048c-14.336 5.504-17.92 17.792-17.92 24.704v216.96c0 6.912 3.584 13.056 9.472 16.64 0 0 200.167 120.09 201.19 120.346 0 0.025 11.93 8.857 23.322 0.998z m-30.464-49.152l-165.12-99.584V589.696l165.12 93.44v185.088z m19.2-218.112L640.65711 558.72l161.024-80.384L962.45011 558.72l-160.768 91.392zM985.74511 768.64l-164.864 99.328V683.136l164.864-93.44V768.64z" fill="#3CBF71" p-id="17929"></path></svg>
            </el-icon>
          </el-row>
        </template>
        <el-col>
          <el-statistic :value="data.affectedProduct"></el-statistic>
          <div style="display: flex; font-size: 13px; margin-top: 6%; gap: 10px;">
            <span>{{ t('app.webui.weeklyadditionsproduct') }}</span>
            <span>{{ data.weeklyAdditionsProduct }}</span>
          </div>
        </el-col>
      </el-card>
    </el-row>
    ...
    <div style="width: 84%; margin: auto;">
      <el-card style="margin-top: 2%;" shadow="always">
    <el-table :data="data.data">
      ...
      <el-table-column prop="vuln_type" :label="t('app.webui.type')" width="180" />
      <el-table-column prop="vuln_level" :label="t('app.webui.level')" width="80" >
      ...
      <el-table-column :label="t('app.webui.status')" width="120">
      <template #default="{ row }">
        <div class="status">
  ...
  <div style="display: flex; margin-left: 85%; margin-top: 1%; align-items: center;">
    <el-link href="#/vulnlist" style="font-size: 18px;">
      <span>{{ t('app.webui.readmore') }}</span>
      <el-icon><DArrowRight /></el-icon></el-link>
  </div>
  </el-card>
    </div>
  </div>
...
const data = ref({})
// 定义一个数组，包含所有要在 onMounted 时执行的函数
const mountedFunctions = [performAction, getVuln]
onMounted(() => {
