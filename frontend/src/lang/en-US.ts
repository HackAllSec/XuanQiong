...
export default {
    app: {
        webui: {
            ...
            apikeyscopes: 'Scopes',
            apikeyscopenotice: 'An API key can only use selected scopes, and scopes cannot exceed current user permissions. Empty expiration defaults to 90 days.',
            apikeyscoperequired: 'Select at least one API key scope',
