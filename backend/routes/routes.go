...
func defineRouter() {
	...
	route.GET("/delete/file", protectedRoute([]string{"attachment.delete"}, "attachment.delete", controllers.DeleteFile)...)
	route.POST(apiuri+"/addvuln", protectedRoute([]string{"vuln.submit"}, "vuln.submit", controllers.AddVuln)...)
	route.POST(apiuri+"/editvuln", protectedRoute([]string{"vuln.edit"}, "vuln.edit", controllers.EditVuln)...)
