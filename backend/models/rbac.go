...
var defaultPermissions = []types.XqPermission{
	...
	{Code: "message.read", Name: "查看站内消息", Category: "message", Description: "允许查看本人站内消息"},
	{Code: "message.update", Name: "更新站内消息", Category: "message", Description: "允许标记本人站内消息已读"},
	{Code: "api.key.read", Name: "查看 API Key", Category: "api_key", Description: "允许查看本人 API Key 列表"},
	{Code: "api.key.manage", Name: "管理 API Key", Category: "api_key", Description: "允许创建和删除本人 API Key"},
	...
	{Code: "vuln.import", Name: "导入漏洞", Category: "vulnerability", Description: "允许批量导入漏洞"},
	{Code: "vuln.export", Name: "导出漏洞", Category: "vulnerability", Description: "允许导出漏洞数据"},
	...
	{Code: "backup.manage", Name: "管理备份恢复", Category: "backup", Description: "允许导出和恢复系统备份"},
}
